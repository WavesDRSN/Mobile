...
data class AuthenticationResponseDto(val success: Boolean, val errorMessage: String?, val jwtToken: String?, val userId: String?)
data class UpdateTokenResponseDto(val success: Boolean, val errorMessage: String?)
